...
APP_ID = '92be8391'
def get_travel_times(start_loc: Point, target_locations: List[Trailhead], max_minutes=40):
    ...
    resp_json = requests.post(URL, json=req, headers={'X-Application-Id': APP_ID, 'X-Api-Key': API_KEY}).json()
    print(resp_json)
