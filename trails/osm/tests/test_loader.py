...
from osm.loader import OsmiumTrailLoader, OSMIngestor, find_loops_from_root, IngestSettings
...
def test_loader(huddart_trails):
    ...
    expected = {'Miramontes Trail', 'Dean Trail', 'Grabtown Gulch Trail', 'Archery Fire Road', 'Summit Spring',
                'Crystal Springs Trail', 'Trail8', 'Trail11 Bypass', 'Richards Road', 'Bear Gulch Trail',
                'Lonely Trail', 'Chinquapin Trail', 'Chapparal Trail', 'Trail7', 'Bay Area Ridge Trail',
                'Campground Trail', 'unamed', 'Purisima Creek Trail', 'Redwood Trail', 'Harkins Ridge Trail',
                'Kings Mountain Trail', 'Borden Hatch Mill Trail', 'Craig Britton Trail', 'Bay Tree Trail',
                'North Ridge Trail', 'Raymundo Trail', 'Mount Redondo Trail', 'Sculpture Garden Trail', 'Skyline Trail',
                'Trail12', 'Trail6'}
